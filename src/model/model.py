...
class LSTMModel:
    def __init__(self, input_shape, units, dropout_rate, num_classes):
        ...
        self.model.add(Bidirectional(LSTM(units=units, activation='tanh', return_sequences=True), input_shape=input_shape))
        self.model.add(TimeDistributed(Dense(units=32, activation='tanh')))
        self.model.add(Dropout(dropout_rate))
        self.model.add(TimeDistributed(Dense(units=num_classes, activation='softmax')))  # Softmax activation for multi-class classification
